			...
			<tbody>
				<c:forEach items="${onePage.list}" var="species" varStatus="status">
  					<tr>
  						...
  						<td width="20%">
  							<a  class="btn btn-success "  href="${pageContext.request.contextPath }/admin/area/edit?areaId=${species.speciesId}" style="height: 30px; padding-top: 1px;">编辑</a>
  							<a  class="btn btn-danger "  href="${pageContext.request.contextPath }/admin/area/delete?areaId=${species.speciesId}"  style="height: 30px; padding-top: 1px;">删除</a>
  						</td>
  					</tr>
  				</c:forEach>
			</tbody>
